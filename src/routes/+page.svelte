...
// @ts-nocheck
    ...
    import { collection, query, setDoc, where, getDocs ,onSnapshot, doc, updateDoc, deleteDoc, addDoc } from "firebase/firestore";
	import {
			getAuth,
		...
		<div class="grid">
		  ...
		  <form class="form login">
			...
			<div class="form__field">
			  ...
			  <input bind:value={email} autocomplete="username" id="login__username" type="text" name="username" class="form__input" placeholder="Username" required>
			</div>
			...
			<div class="form__field">
			  ...
			  <input bind:value={password} id="login__password" type="password" name="password" class="form__input" placeholder="Password" required>
			</div>
			...
			<div class="form__field">
			  ...
			  <div class="form__field">
				...
				<input on:click={loginWithGoogle} type="submit" value="Login with google" style="background-color: white; color:black" >
			  </div>
